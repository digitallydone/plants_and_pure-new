...
const footerLinks = {
  shop: [
    ...
    { name: "Herbs", href: "/products?category=herbs" },
    { name: "Essential Oils", href: "/products?category=oils" },
  ],
  company: [
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              Dealer in natural herbal oils for smoother skin, nourished hair, and edible spices for healthier benefits.
              Made from 100% natural ingredients.
            </p>
            <div className="mt-6 space-y-2">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Mail className="h-4 w-4" />
                <span>plantsandpure@gmail.com</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Phone className="h-4 w-4" />
                <span>+233 59 608 3867</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground">Subscribe for recipes, tips and exclusive offers.</p>
        ...
        <div className="mt-12 border-t border-border pt-8">
          <p className="text-center text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Plants & Pure Limited. Made with love in Ghana.
          </p>
        </div>
      </div>
    </footer>
